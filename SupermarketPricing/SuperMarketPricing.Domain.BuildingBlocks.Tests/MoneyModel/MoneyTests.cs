...
namespace SuperMarketPricing.Domain.BuildingBlocks.Tests.MoneyModel
{
    public class MoneyTests
    {
        ...
        [Fact]
        public void NoMoney_HasAmountZeroAndDollarCurrency()
        {
            var nm = Money.NoMoneyDollars();

            Assert.Equal(0.0m, nm.Amount);
            Assert.Equal("USD".ToCurrency(), nm.Currency);
        }
